...
define("echarts/config", [], function () {
	...
	function m(e, t, n) {
		...
		if (e.isCover(t, n)) {
			...
			var i = e.parent;
			while (i) {
				if (i.clipShape && !i.clipShape.isCover(this._mouseX, this._mouseY))
					return !1;
				i = i.parent
			}
	...
	l = {
		...
		click : function (e) {
			...
			(t && t.clickable || !t) && this._dispatchAgency(t, u.CLICK, e),
			this._mousemoveHandler(e)
		},
		dblclick : function (e) {
			e = this._zrenderEventFixed(e);
			var t = this._lastHover;
			(t && t.clickable || !t) && this._dispatchAgency(t, u.DBLCLICK, e),
			this._mousemoveHandler(e)
		},
		...
		mousemove : function (e) {
			...
			if (this._draggingTarget)
				this.storage.drift(this._draggingTarget.id, t, n), this.storage.addHover(this._draggingTarget);
	...
	c.prototype._paintList = function (e, n) {
		...
		for (var f in this._layers)
			f !== "hover" && (this._layers[f].unusedCount++, this._layers[f].updateTransform());
		var l = [];
	...
	c.prototype.toDataURL = function (e, n, i) {
		...
		this.storage.iterShape(function (e) {
			if (!e.invisible)
				if (!e.onbrush || e.onbrush && !e.onbrush(o, !1))
					if (t.catchBrushException)
						try {
	...
	return h.prototype = {
		...
		_markPoint : function (e, t) {
			...
			if (!t.large)
				for (var w = 0, E = u.length; w < E; w++) {
					if (typeof u[w].x == "undefined" || typeof u[w].y == "undefined")
						continue;
		...
		_markLine : function (e, t) {
			...
			for (var E = 0, S = u.length; E < S; E++) {
				if (typeof u[E][0].x == "undefined" || typeof u[E][0].y == "undefined" || typeof u[E][1].x == "undefined" || typeof u[E][1].y == "undefined")
					continue;
				c && (h = c.getColor(n.name)),
	...
	return l.prototype = {
		_init : function () {
			...
			for (var i in t.EVENT)
				i != "CLICK" && i != "DBLCLICK" && i != "HOVER" && i != "MOUSEOUT" && i != "MAP_ROAM" && this._messageCenter.bind(t.EVENT[i], this._onevent, this);
			var s = {};
	...
	var n,
	r = typeof window == "undefined" && typeof t == "undefined";
	r ? n = {
		create : function (e, t) {
